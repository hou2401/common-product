...
public class AuthEnterpriseParams extends ServiceParams{
	...
	public Map<String,String> getHeader() throws EnterpriseAuthException {
		...
		hashMap.put(HttpRequset.CONTENT_SIGNATURE, getSignature(getEnterpriseSign()));
		return hashMap;
	}
	 ...
	 * @param agentImg
	 */
	public AuthEnterpriseParams(String appId, String serviceCode, String secretKey, String url, String name,
