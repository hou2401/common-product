...
public class PagesSignItem {
    ...
    /**
     * 印章资源地址，<br />sealBytes和sealURI都不填，无印章图片的签章<br />同时存在时，sealBytes优先。
    ...
    /**
     * 结合coordinateAxisType和sealPoint来确定印章在坐标X轴位置<br />默认印章水平居中， A4文件大小：21cm×29.7cm
     */
    private Float x;
    /**
     * 结合coordinateAxisType和sealPoint来确定印章在坐标Y轴位置，<br />默认印章垂直居中
     */
    private Float y;
}
